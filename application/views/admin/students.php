		...
		<div class="card mb-4">
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				<h6 class="m-0 font-weight-bold text-primary">
					<button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#addStudentModal"><i class="fas fa-plus"></i> เพิ่มนักศึกษาพิเศษ</button>
				</h6>
			</div>
			<div class="card-body">
						...
						<tbody>
							...
							foreach($listStudent as $r){ ?>
								<tr>
									...
									<td>
										<a href="<?php echo site_url("admin/deleteStudentS/{$r['dept_id']}/{$r['student_id']}"); ?>" class="btn btn-danger btn-sm" onclick="return confirm('ต้องการลบนักศึกษานี้หรือไม่?');" title="ลบหน่วยงาน"><i class="far fa-trash-alt"></i></a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="addRegistLabel"><i class="fas fa-plus"></i> เพิ่มนักศึกษาพิเศษ</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
			</div>
			<form action="<?php echo site_url('admin/addStudentS'); ?>" method="post">
