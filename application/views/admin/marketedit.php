			...
			<div class="card-body">
				<form action="<?php echo site_url("admin/marketeditaction");?>" method="post"  role="form" enctype="multipart/form-data">
					...
					<div class="row text-center">
						...
						<div class="col-6 mt-3">
                            <a href="<?php echo site_url("admin/marketdetail/{$marketdetail[0]['m_id']}"); ?>" class="btn form-control btn-sm btn-light d-flex align-items-center justify-content-center">ยกเลิก</a>
                        </div>
                    </div>
                </form>
			</div>
