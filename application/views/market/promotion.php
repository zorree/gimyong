...
<div class="col-12" id="container-wrapper">
	<div class="d-sm-flex align-items-center justify-content-between mb-2">
		<h1 class="h3 mb-0 text-gray-800">รายละเอียดโปรโมชั่น</h1>
		<ol class="breadcrumb">
		...
		<div class="card mb-4">
			<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
				<!-- <h6 class="m-0 font-weight-bold text-primary">
                    โปรโมชั่นของร้าน<?php echo $listpromotion[0]['m_shopname'];?>
				</h6> -->
				<h6 class="m-0 font-weight-bold text-primary">
					<button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#addPromotion"><i class="fas fa-plus"></i> เพิ่มโปรโมชั่น</button>
				</h6>
			</div>
			<div class="card-body">
					...
					<div class="tab-pane fade show active" id="regist" role="tabpanel" aria-labelledby="regist-tab">
                        ...
                        <div class="table-responsive">	
							<table class="table table-nowrap table-bordered text-center">
								...
								<tbody>
									<?php echo count($listpromotion) == 0 ? '<td colspan="5">-ไม่มีข้อมูล-</td>' : ''; ?>
									<?php $num = 0;
									foreach($listpromotion as $r){ ?>
										<tr>
                                            <td><?php echo ++$num;?></td>
                                            <td><?php echo $r['g_name'];?></td>
											<td><?php echo $r['g_price'];?></td>
...
<div class="modal fade" id="addPromotion" tabindex="-1" role="dialog" aria-labelledby="addRegistLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="addRegistLabel"><i class="fas fa-plus"></i> เพิ่มโปรโมชั่นสินค้า</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
			</div>
			<form action="<?php echo site_url('market/addPromotion'); ?>" method="post">
				<div class="modal-body">
					<div class="table-responsive">
						<table class="table">
							<!-- <input type="hidden" name="g_name" value="<?php echo $r['g_id'];?>"> -->
							<tr>
										<?php 
								...
								<td>สินค้า</td>
								<td>
									<select name="g_name" class="form-control form-control-sm" required>
										<?php 
												foreach($addPromotion as $r){ 
										?>
											<option value="<?php echo $r['g_name']; ?>"><?php echo $r['g_name']; ?> ราคา <?php echo $r['g_price']; ?> บาท</option>
							...
							<tr>
								<td>ราคาลด</td>
								<td><input type="text" class="form-control form-control-sm" name="p_price" value="" required></td>
							</tr>
							<tr>
								<td>วันที่เริ่มโปรโมชั่น</td>
								<td><input type="date" class="form-control form-control-sm" name="p_timestart" value="<?php echo date('Y-m-d'); ?>" required></td>
							</tr>
							<tr>
								<td>วันที่หมดโปรโมชั่น</td>
								<td><input type="date" class="form-control form-control-sm" name="p_timesend" value="<?php echo date('Y-m-d'); ?>" required></td>
							</tr>
							<?php 
												}
											}else{
										?>
							<tr>
								<td class="text-center">โปรโมชั่นครบทุกสินค้า</td>
							</tr>
										<?php
											}
										?>
